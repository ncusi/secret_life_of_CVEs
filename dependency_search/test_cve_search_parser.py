...
class Test(TestCase):
    ...
    def test_find_file_name_extensions(self):
        ...
        self.assertEqual(extensions[b'.md'], 1)
        self.assertEqual(extensions[b'.yml'], 1)
        self.assertEqual(extensions[b'.png'], 3)
        self.assertEqual(extensions[b'.txt'], 1)
        self.assertEqual(extensions[b'.py'], 13)
        self.assertEqual(extensions[b'.pyc'], 1)
        self.assertEqual(extensions[b'.sqlite3'], 1)
        self.assertEqual(extensions[b'.sh'], 1)
