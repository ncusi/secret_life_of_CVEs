...
"""Usage: %(scriptName) <unique_cve_info-cvss_cwe_etc.parquet> <cve_lifespan_language_df> <cve_survival_input_df>
...
def main():
    ...
    cve_survival_input_df_filename = sys.argv[3]
    ...
    cve_survival_input_df_ = merge_dfs(unique_cve_info_cvss_cwe_etc_df, cve_lifespan_language_df_df)

    cve_survival_input_df_.to_parquet(cve_survival_input_df_filename)
